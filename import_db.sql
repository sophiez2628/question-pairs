...
VALUES
  ...
  ((SELECT id FROM questions WHERE title = 'color'),(SElECT id FROM users WHERE fname = 'Patrick')),
...
VALUES
  ((SELECT id FROM questions WHERE title = 'bonus'), NULL,
    (SELECT id FROM users WHERE fname = 'Patrick'),'Yes!');

INSERT INTO
  replies (question_id, reply_id, user_id, body)
VALUES
  ((SELECT id FROM questions WHERE title = 'bonus'), (SELECT id FROM replies WHERE body = 'Yes!'),
    (SELECT id FROM users WHERE fname = 'Sophie'),'Terrific!');
